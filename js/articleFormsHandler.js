...
export default class articleFormsHandler {
     ...
     */
    constructor(articlesServerUrl, type) {
    ...
    assignFormAndArticleForInsert(formElementId, cssClass2hideElement){
        this.cssCl2hideElm  = cssClass2hideElement;
        const artForm=document.getElementById(formElementId);
        this.formElements=artForm.elements;
        ...
        artForm.onsubmit= (event)=>this.processArtAdd(event);
    ...
    processArtEditFrmData(event) {
        ...
        const articleData = {
            ...
            author: localStorage.getItem("user") == null ? this.formElements.namedItem("author").value.trim() : localStorage.getItem("user"),
